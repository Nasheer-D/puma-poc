            ...
            it('should return the tx data for item', (done) => {
                server.get(`${endpoint}/tx/${sessionID}/${testItem.itemID}`)
                    ...
                    .end((err: Error, res: any) => {
                        ...
                        expect(body.data[0]).to.have.property('callback').that.is.equal(`http://172.25.16.1:8080/${endpoint}/txStatus/session/${sessionID}`);
            ...
            it('should return the tx data plain for item', (done) => {
                server.get(`${endpoint}/tx/plain/${sessionID}/${testItem.itemID}`)
                    ...
                    .end((err: Error, res: any) => {
                        ...
                        expect(body).to.have.property('callback').that.is.equal(`http://172.25.16.1:8080/${endpoint}/txStatus/session/${sessionID}`);
